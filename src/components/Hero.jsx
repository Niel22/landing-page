  ...
  return (
    <div id="home" className='container mx-auto pt-44 pb-16 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center'>
      ...
      <div className='w-full md:w-1/2 space-y-8'>
        ...
        <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold leading-tight'>Empowering growth for  
        ...
        <p className='text-gray-600 text-lg md:text-xl max-w-xl'>Unlock better opportunities with advanced analytics, sales tools, and personalized training — all under one seamless solution.</p>

        <div className='flex flex-col gap-3 max-w-md md:flex-row'>
            ...
            <button className='bg-blue-600 flex justify-center items-center px-8 py-4 rounded-xl text-white hover:bg-blue-700 transition-all hover:shadow-lg hover:shadow-blue-300'><HiOutlineArrowNarrowRight /></button>
        </div>
      </div>
