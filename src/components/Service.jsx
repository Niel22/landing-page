...
const Service = () => {
  ...
  return (
    <div id="services" className='py-20 container mx-auto px-4 sm:px-6 lg:px-8'>
      <div className='flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24'>
        <div className='md:w-1/2 w-full'>
            ...
            <div className='space-y-3'>
                <div className='flex items-center gap-2 '>
                    <div className='w-5 h-5 rounded-full bg-indigo-100 flex items-center justify-center'>
                        <div className='w-1/2 h-1/2 rounded-full bg-indigo-600'></div>
                    </div>
            ...
            <button className='mt-8 bg-indigo-600 text-white px-8 py-3 rounded-full hover:bg-indigo-700 transition-all'>Get Started</button>
        </div>
